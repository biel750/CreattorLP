...
import sty from "./PlasmicFooter.module.css"; // plasmic-import: 9OL-MM7ld115y/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <p.PlasmicLink
            className={classNames(projectcss.all, projectcss.a, sty.link__eWb4)}
            component={Link}
          ...
          >
            <p.PlasmicImg
              alt={""}
              className={classNames(sty.img__a7BVs)}
          ...
          >
            <p.PlasmicImg
              alt={""}
              className={classNames(sty.img__bhV6K)}
              displayHeight={"auto" as const}
              displayMaxHeight={"none" as const}
              displayMaxWidth={"100%" as const}
              displayMinHeight={"0" as const}
          ...
          >
            <p.PlasmicImg
              alt={""}
              className={classNames(sty.img__wJbr6)}
              displayHeight={"auto" as const}
              displayMaxHeight={"none" as const}
              displayMaxWidth={"100%" as const}
              displayMinHeight={"0" as const}
...
const PlasmicDescendants = {
  root: ["root", "footer", "freeBox", "text"],
  footer: ["footer", "freeBox", "text"],
  freeBox: ["freeBox"],
  text: ["text"]
} as const;
