...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 8uJGPonSAj-MG/css
    ...
    <p.Stack
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolor_darkBlue_shape_rounded]:
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__bomC6)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__uSgLn)}
                role={"img"}
              />
            ),
